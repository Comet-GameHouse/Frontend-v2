...
function FeaturedGamesSection({ onNavigate }: FeaturedGamesProps) {
  return (
    <section className="mx-auto max-w-6xl space-y-6 px-6" data-aos="fade-up" data-aos-duration="300" data-aos-delay="150">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {GAMES.map(({ title, meta, icon }, idx) => (
          <Card key={title} variant="cosmic" className="space-y-3" onClick={() => onNavigate('/games')} data-aos="fade-up" data-aos-duration="300" data-aos-delay={String(200 + idx * 50)}>
