...
function FeaturesSection() {
  return (
    <section className="mx-auto max-w-6xl space-y-6 px-6" data-aos="fade-up" data-aos-duration="300">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {FEATURES.map(({ icon, title, copy }, idx) => (
          <Card key={title} variant="glass" className="space-y-3" data-aos="fade-up" data-aos-duration="300" data-aos-delay={String(150 + idx * 50)}>
