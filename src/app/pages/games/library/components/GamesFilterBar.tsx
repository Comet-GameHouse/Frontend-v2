...
function GamesFilterBar({ tags, activeTag, onTagChange, query, onQueryChange }: GamesFilterBarProps) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-slate-800 bg-slate-900/60 p-6" {...getAOSProps({ 'data-aos': 'fade-up', 'data-aos-duration': '300', 'data-aos-delay': '150' })}>
