...
function GameUpdates({ updates }: GameUpdatesProps) {
  return (
    <Card variant="void" className="space-y-4" data-aos="fade-up" data-aos-duration="300" data-aos-delay="300">
      ...
      <ul className="space-y-3">
        {updates.map((update, idx) => (
          <li key={update.title} className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3" data-aos="fade-up" data-aos-duration="300" data-aos-delay={String(350 + idx * 50)}>
